...
insert into produit(code,designation,prix_u,prix_v,prix_r,qte)values ('200020020221','Piston',2000,2300,2150,4)
insert into produit(code,designation,prix_u,prix_v,prix_r,qte)values ('200020020222','Geante à Léage R-line',26000,23000,22500,5)
insert into produit(code,designation,prix_u,prix_v,prix_r,qte)values ('','Design Batman',2200,2500,2400,4)
insert into facture_four(id_f,montant,versé,reste,date_fact)values(1,52000,52000,0,GETDATE())
insert into achat(id_f,id_p,prix_a,prix_v,prix_r,qte,qte_vendue)values(1,2,23000,26000,25000,3,0)
insert into achat(id_f,id_p,prix_a,prix_v,prix_r,qte,qte_vendue)values(1,2,26000,29000,28000,2,0)
insert into achat(id_f,id_p,prix_a,prix_v,prix_r,qte,qte_vendue)values(1,1,2000,2300,2150,4,0)
insert into achat(id_f,id_p,prix_a,prix_v,prix_r,qte,qte_vendue)values(1,3,2200,2500,2400,2,0)
